...
```bash
esptool.py --port COM7 write_flash 0xA20000 assets_lfs.img
...
Flash will be erased from 0x00a20000 to 0x00c1ffff...
Compressed 2097152 bytes to 2237...
Wrote 2097152 bytes (2237 compressed) at 0x00a20000 in 6.6 seconds (effective 2556.9 kbit/s)...
